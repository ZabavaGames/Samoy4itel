...
public class MainLevelShow : MonoBehaviour {
	...
	private const string Level = "Ваш уровень: ";
	...
	private static string[] helpa = {
		"Если вы не закончили задание и вышли, то сможете потом продолжить.",
		"Вы можете повторить задание, если оно вам понравилось.",
		"Если вы не можете найти ошибку, воспользуйтесь подсказкой!",
		"Когда ищете ошибку, не торопитесь. Правильный ответ важнее, чем потраченное время!",
		"Непонятный пример можно пропустить, но это ухудшит ваш результат. :-(",
		"Задания кажутся слишком легкими? Попробуйте более сложный уровень!",
		"На сложном уровне вас ждут случайные примеры - всегда новые!",
		"Если вам нравится игра, поставьте нам оценку в Play Market. :-)",
